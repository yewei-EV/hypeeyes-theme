...
function renderHomePage(req, resp) {
	...
	if (process.env.NODE_ENV === 'development') {
		prefix = 'http://127.0.0.1:4200/hypeeyes/web';
	}
...
theme.init = function (params, callback) {
	...
	params.router.use('/custom', params.middleware.buildHeader, renderHomePage);
	params.router.use('/api/custom', renderHomePage);
